...
local Config = {
    ...
    -- [6] GUI Management
    OldGuiName      = "Phathud", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "Phathud", -- Name of the main script's GUI to check if it's already executing
